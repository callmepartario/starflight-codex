...
function printInterface() {
	document.writeln("<form name='SFCW'>\n");
	document.writeln("<select class='border-shape2 h7' name='Planets' onchange='revealCode();'>\n");
	for (i = 0; i < planets.length; i++) { 
		document.writeln("<option>" + planets[i] + "</option>\n");
	}
	document.writeln("</select>\n");
	document.writeln("<select class='border-shape h7' name='Artifacts' onchange='revealCode();'>\n");
	for (i = 0; i < artifacts.length; i++) { 
		document.writeln("<option>" + artifacts[i] + "</option>\n");
	}
	document.writeln("</select>\n");
	document.writeln("<select class='border-shape2 h7' name='Races' onchange='revealCode();'>\n");
	for (i = 0; i < races.length; i++) {
		document.writeln("<option>" + races[i] + "</option>\n");
	}
	document.writeln("</select>\n");
	document.writeln("<input type='text' name='Code' class='border-shape h7'>\n");
}

function revealCode() {
	planet = document.forms.SFCW.Planets.selectedIndex;
	artifact = document.forms.SFCW.Artifacts.selectedIndex;
	race = document.forms.SFCW.Races.selectedIndex;
	codeIndex = (planet - artifact);
	while (codeIndex < 0) {
